...
Resolve bugs e adiciona o /perfil
E mais 3 comandos de economia como apostas de moedas e melhora a interface de boas-vindas vidas adicionando imagem do membro novo e um ambed e o sistema de ping 🏓

e resolve o bug de quando uso o comando de adicionar moedas não aparece no /perfil e escreve tudo do inicio ao fim import discord
import random
import asyncio
import json
import os
